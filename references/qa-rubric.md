...
- Art reads as a compact 3D Codex desktop pet sprite, not pixel art, a polished illustration, a photo, or a glossy app icon.
- Silhouette is compact and chunky enough to read inside a `192x208` cell.
- Materials are simplified and consistent: soft fur, fabric, glossy eyes, collars, bows, or small accessories are allowed when they remain readable at pet size.
- Lighting is clean and consistent across rows, with no cast shadows or floor contact shadows baked into the sprite.
- No pixel-art outlines, visible stepped edges, painterly texture, photorealism, over-detailed fur, or tiny accessories that disappear at pet size.
...
- Action rows coordinate multiple body cues where appropriate: head, eyes, mouth, ears, tail, paws/feet, and body. Reject rows where only one pasted part moves and the rest of the pet feels frozen.
