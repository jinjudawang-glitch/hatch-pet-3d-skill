...
- Do not redesign the pet. Keep the exact same head shape, face design, markings, body proportions, palette, 3D material style, accessories, and props as the approved base pet.
- If the repaired row is an action, coordinate several small cues across head, eyes, mouth, ears, tail, paws/feet, and body instead of moving only one pasted part.
